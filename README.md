...
Para resolverla, se desarrollaron cuatro barras de progreso que avanzan de forma aleatoria mientras aumenta su porcentaje de progreso.
...
- 🔄 Opción para reiniciar la carrera.
- ✅ Confirmación del resultado mediante una alerta.

## 🏁 Funcionamiento

1. Se inicia la carrera.
2. Cada caballo avanza de forma aleatoria.
3. Las barras de progreso se actualizan durante la carrera.
4. El primer caballo que llega al **100 %** gana.
